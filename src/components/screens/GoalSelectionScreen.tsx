...
// Goals with gradient color pairs (left → right)
const goals = [
...
export function GoalSelectionScreen({ onNavigate }: GoalSelectionScreenProps) {
  ...
  return (
    <div className="h-screen flex flex-col px-6 py-10 bg-[#1a1d2e] relative overflow-hidden">
      {/* Wave pattern background accents */}
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        {/* Goals List - centered with large spacing */}
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 relative">
                  {/* Circular Checkmark with gradient ring */}
                  ...
                  {/* Goal Text with gradient */}
                  <div className="flex-1 text-left relative">
                    {isSelected ? (
                      <>
                        {/* Glow for selected text */}
                        <div 
